...
func newSegment(dir string, baseOffset uint64, c Config) (*segment, error) {
	...
	if off, _, err := s.index.Read(-1); err != nil {
		...
		// If the index has at least one entry, then that means the offset of the next
		// record written should take the offset at the end of the segment, which we
		// get by adding 1 to the base offset and relative offset.
...
// Close closes index and store files.
